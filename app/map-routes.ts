...
const city=(n:string)=>/福州/.test(n)?'福州':/仙都|鼎湖峰|朱潭山|小赤壁/.test(n)?'缙云':/丽水|画乡|古堰/.test(n)?'丽水':/云和|梯田/.test(n)?'云和':/歙县|徽州|格林豪泰|渔梁/.test(n)?'歙县':/黄山北/.test(n)?'黄山':/千岛湖/.test(n)?'淳安':/泰宁|金湖|九龙潭|长兴/.test(n)?'泰宁':/梅州|客家|嘉应|千佛塔|东山书院/.test(n)?'梅州':/磐安围/.test(n)?'兴宁':/热矿泥|五华/.test(n)?'五华':/土楼|田螺坑|裕昌楼|塔下/.test(n)?'南靖':/东山|南门湾|风动石/.test(n)?'东山':'漳州';
...
const roadLegs:Record<string,Record<string,[string,string][]>>={
 qiandao:{'0-0':[['福州鼓楼区','福州站'],['千岛湖站','千岛湖绿城蓝湾度假酒店']],'1-0':[['千岛湖绿城蓝湾度假酒店','千岛湖中心湖区旅游码头']],'1-1':[['千岛湖中心湖区旅游码头','千岛湖绿城蓝湾度假酒店']],'2-0':[['千岛湖绿城蓝湾度假酒店','千岛湖站']],'2-1':[['歙县北站','格林豪泰酒店（歙县徽州古城店）'],['格林豪泰酒店（歙县徽州古城店）','歙县徽州古城']],'2-2':[['歙县徽州古城','格林豪泰酒店（歙县徽州古城店）']],'3-0':[['格林豪泰酒店（歙县徽州古城店）','歙县渔梁古镇']],'3-1':[['歙县渔梁古镇','黄山北站']],'3-2':[['福州站','福州鼓楼区']]},
